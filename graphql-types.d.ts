...
export type BackgroundImageQuery = { allImageSharp: { nodes: Array<{ fluid?: Maybe<(
...
export type ImageQuery = { allImageSharp: { nodes: Array<{ fluid?: Maybe<(
        Pick<ImageSharpFluid, 'originalName'>
        & GatsbyImageSharpFluid_WithWebpFragment
      )> }> } };
...
export type SeoQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'siteUrl' | 'author'>> }> };
