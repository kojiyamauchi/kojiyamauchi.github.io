  ...
  return (
    <div className={`${styles.wrapper} about-me`}>
      ...
      <p className={`${styles.letter} letter is-en`}>
        ...
        <br />
        My skills, TypeScript / JavaScript / React / Next.js / Webpack / Gulp / Node.js / GitHub / Sass / CSS / HTML / VSCode / Figma(a little) / Sketch(a
      ...
      <p className={`${styles.letter} letter is-jp`}>
        ...
        <br />
        使用言語・開発環境等は、TypeScript・JavaScript・React・Next.js・Webpack・Gulp・Node.js・GitHub・Sass・CSS・HTML・VSCode・Figma(少々)・Sketch(少々)・Photoshop・Illustratorになります。
        <br />
